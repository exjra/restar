...
{
    return nullptr;//(LIBDECODEQR_VERSION);
}
char *qr_decoder_version_description()
{
    return nullptr;//(LIBDECODEQR_VERSION_DESCRIPTION);
}
char *qr_decoder_version_product()
{
    return nullptr;//(LIBDECODEQR_PRODUCTNAME);
}
...
{
    return nullptr;//(LIBDECODEQR_VERSION_SUFFIX);
}
char *qr_decoder_version_revision()
{
    return nullptr;//(LIBDECODEQR_VERSION_REVISION);
}
