...
namespace Qr{
    namespace ECI{
        ...
        NumericalDecoder::NumericalDecoder() : Decoder()
        {
            this->mode=1;
        ...
        AlphabeticalDecoder::AlphabeticalDecoder() : Decoder()
        {
            this->mode=2;
        ...
        ByteDecoder::ByteDecoder() : Decoder()
        {
            this->mode=4;
        ...
        GenericDecoder::GenericDecoder() : Decoder()
        {
            this->mode=7;
        }
        ...
        KanjiDecoder::KanjiDecoder() : Decoder()
        {
            this->mode=8;
